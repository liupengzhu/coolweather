...
public class activity_Weather extends AppCompatActivity {
    ...
    {
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+weatherId+"&key=2952cc1a58644562accedc1f73e9a98b";
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(activity_Weather.this).load(bingPic).into(bingpiImg);
                    }
                });
